# Full VM Configuration with OpenClaw and Cockpit
#
# This is a complete, ready-to-run NixOS configuration for a VM.
# Just generate hardware-configuration.nix and create your secrets.

{ config, pkgs, modulesPath, ... }:

{
  imports = [
    # QEMU guest profile - virtio modules, rngd, timing fixes
  ...
  # VM Guest Services
  # ===================
  # QEMU guest agent - allows hypervisor to manage VM (shutdown, snapshot, etc.)
  services.qemuGuest.enable = true;
  # SPICE agent - clipboard sharing between host and guest
  services.spice-vdagentd.enable = true;

  # ===================
  # Boot Configuration
  # ===================
  # For UEFI VMs (QEMU, Proxmox, etc.)
  boot.loader.systemd-boot.enable = true;
  boot.loader.efi.canTouchEfiVariables = true;

  # For legacy BIOS VMs, uncomment these instead:
